document.addEventListener("DOMContentLoaded",function(){if(window.location.pathname==="/account/deposit"){console.log("Disable /account/deposit.");return}const style=document.createElement("style");style.textContent=`
        canvas {
            position: fixed;
            top: 0;
            left: 0;
